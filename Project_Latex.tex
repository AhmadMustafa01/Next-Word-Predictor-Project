...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{model summary.png}
...
\bibitem{b1}https://www.geeksforgeeks.org/next-word-prediction-with-deep-learning-in-nlp/
\bibitem{b2}https://medium.com/@ilaslanduzgun/next-word-prediction-using-lstm-with-tensorflow-e2a8f63b613c
\bibitem{b3} https://thecleverprogrammer.com/2023/07/17/next-word-prediction-model-using-python/
\bibitem{b4} K. Elissa, ``Title of paper if known,'' unpublished.
\bibitem{b5} Rianti, Afika and Widodo, Suprih and Ayuningtyas, Atikah and Hermawan, Bima. (2022). NEXT WORD PREDICTION USING LSTM. Journal of Information Technology and Its Utilization. 5. 10.56873/jitu.5.1.4748.
